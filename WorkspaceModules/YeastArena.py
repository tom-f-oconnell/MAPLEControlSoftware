...
class YeastArena:
    def __init__(self, anchorX, anchorY):
        nrows = 1       # maximum possible rows and columns in arena
        ncols = 2
        ...
        self.SPz = 50.4
        camdiffy = 6.3
        self.camsharpz = 42      # position at which POIs are sharp
        xdif = 130       # x difference between POIs
        ydif = 130       # y difference between POIs
        self.POIz = 49
        self.Vacz = 50
        self.agarZ = 38.7     # height at which to probe and place colonies
